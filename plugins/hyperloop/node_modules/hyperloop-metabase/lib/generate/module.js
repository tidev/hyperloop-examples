...
function makeModule (json, module) {
	var entry = {
		class: {
			name: module.name,
			properties: [],
			class_methods: [],
			obj_class_method: [],
			static_variables: module.static_variables,
	...
	entry.frameworks[module.framework]=1;
